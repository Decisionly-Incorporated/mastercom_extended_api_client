...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MasterCom.ClaimDetail();
  });
  ...
  describe('ClaimDetail', function() {
    it('should create an instance of ClaimDetail', function() {
      // uncomment below and update the code to test ClaimDetail
      //var instance = new MasterCom.ClaimDetail();
      //expect(instance).to.be.a(MasterCom.ClaimDetail);
    });
    ...
    it('should have the property standardClaims (base name: "standardClaims")', function() {
      // uncomment below and update the code to test the property standardClaims
      //var instance = new MasterCom.ClaimDetail();
      //expect(instance).to.be();
    });
    ...
    it('should have the property retrievalDetails (base name: "retrievalDetails")', function() {
      // uncomment below and update the code to test the property retrievalDetails
      //var instance = new MasterCom.ClaimDetail();
      //expect(instance).to.be();
    });

    it('should have the property chargebackDetails (base name: "chargebackDetails")', function() {
      // uncomment below and update the code to test the property chargebackDetails
      //var instance = new MasterCom.ClaimDetail();
      //expect(instance).to.be();
    });

    it('should have the property feeDetails (base name: "feeDetails")', function() {
      // uncomment below and update the code to test the property feeDetails
      //var instance = new MasterCom.ClaimDetail();
      //expect(instance).to.be();
    });

    it('should have the property retrievalDetailsList (base name: "retrievalDetailsList")', function() {
      // uncomment below and update the code to test the property retrievalDetailsList
      //var instance = new MasterCom.ClaimDetail();
      //expect(instance).to.be();
    });
