...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MasterCom.CaseFilingClaim();
  });
  ...
  describe('CaseFilingClaim', function() {
    it('should create an instance of CaseFilingClaim', function() {
      // uncomment below and update the code to test CaseFilingClaim
      //var instance = new MasterCom.CaseFilingClaim();
      //expect(instance).to.be.a(MasterCom.CaseFilingClaim);
    });
