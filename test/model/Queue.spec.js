...
(function(root, factory) {
  ...
  describe('Queue', function() {
    it('should create an instance of Queue', function() {
      ...
      //var instance = new MasterCom.Queue();
      //expect(instance).to.be.a(MasterCom.Queue);
    });
    ...
    it('should have the property queueDescription (base name: "queueDescription")', function() {
      // uncomment below and update the code to test the property queueDescription
      //var instance = new MasterCom.Queue();
      //expect(instance).to.be();
    });
