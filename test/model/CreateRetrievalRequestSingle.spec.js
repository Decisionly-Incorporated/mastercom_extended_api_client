...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MasterCom.CreateRetrievalRequestSingle();
  });
  ...
  describe('CreateRetrievalRequestSingle', function() {
    it('should create an instance of CreateRetrievalRequestSingle', function() {
      // uncomment below and update the code to test CreateRetrievalRequestSingle
      //var instance = new MasterCom.CreateRetrievalRequestSingle();
      //expect(instance).to.be.a(MasterCom.CreateRetrievalRequestSingle);
    });
