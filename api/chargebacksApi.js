...
var ChargebacksApi = /** @class */ (function () {
     ...
     */
    ChargebacksApi.prototype.acknowledgeChargebacks = function (body_1) {
        return __awaiter(this, arguments, void 0, function (body, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/v6/chargebacks/acknowledge';
     ...
     */
    ChargebacksApi.prototype.createChargeback = function (claimId_1, body_1) {
        return __awaiter(this, arguments, void 0, function (claimId, body, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_2, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/v6/claims/{claim-id}/chargebacks'
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(body, "CreateChargebackRequest")
                };
                authenticationPromise = Promise.resolve();
                authenticationPromise = authenticationPromise.then(function () { return _this.authentications.default.applyToRequest(localVarRequestOptions); });
                interceptorPromise = authenticationPromise;
     ...
     */
    ChargebacksApi.prototype.createChargebackReversal = function (claimId_1, chargebackId_1) {
        return __awaiter(this, arguments, void 0, function (claimId, chargebackId, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_3, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/v6/claims/{claim-id}/chargebacks/{chargeback-id}/reversal'
                    .replace('{' + 'claim-id' + '}', encodeURIComponent(String(claimId)))
     ...
     */
    ChargebacksApi.prototype.getChargebackDoc = function (claimId_1, chargebackId_1, format_1) {
        return __awaiter(this, arguments, void 0, function (claimId, chargebackId, format, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/v6/claims/{claim-id}/chargebacks/{chargeback-id}/documents'
                    .replace('{' + 'claim-id' + '}', encodeURIComponent(String(claimId)))
                    .replace('{' + 'chargeback-id' + '}', encodeURIComponent(String(chargebackId)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
     ...
     */
    ChargebacksApi.prototype.getDataForCreateChargeback = function (claimId_1, body_1) {
        return __awaiter(this, arguments, void 0, function (claimId, body, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/v6/claims/{claim-id}/chargebacks/loaddataforchargebacks'
                    .replace('{' + 'claim-id' + '}', encodeURIComponent(String(claimId)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(body, "LoadDataForChargebacksRequest")
                };
                authenticationPromise = Promise.resolve();
                authenticationPromise = authenticationPromise.then(function () { return _this.authentications.default.applyToRequest(localVarRequestOptions); });
                interceptorPromise = authenticationPromise;
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "LoadDataForChargebackResponse");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new apis_1.HttpError(response, body, response.statusCode));
     ...
     */
    ChargebacksApi.prototype.retrieveChargebackImageStatus = function (body_1) {
        return __awaiter(this, arguments, void 0, function (body, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/v6/chargebacks/imagestatus';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
     ...
     * @param body Chargeback information
     */
    ChargebacksApi.prototype.retrieveChargebackStatus = function (body_1) {
        return __awaiter(this, arguments, void 0, function (body, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/v6/chargebacks/status';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
     ...
     */
    ChargebacksApi.prototype.updateChargeback = function (claimId_1, chargebackId_1, body_1) {
        return __awaiter(this, arguments, void 0, function (claimId, chargebackId, body, options) {
            ...
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/v6/claims/{claim-id}/chargebacks/{chargeback-id}'
                    .replace('{' + 'claim-id' + '}', encodeURIComponent(String(claimId)))
                    .replace('{' + 'chargeback-id' + '}', encodeURIComponent(String(chargebackId)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
