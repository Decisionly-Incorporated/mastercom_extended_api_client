...
import { RepresentmentCreate } from '../model/representmentCreate';
import { RepresentmentCreateEventId } from '../model/representmentCreateEventId';
import { RepresentmentReversal } from '../model/representmentReversal';
import { RepresentmentReversalEventId } from '../model/representmentReversalEventId';
import { RepresentmentUpdate } from '../model/representmentUpdate';
...
export enum RepresentmentsApiApiKeys {
}

export class RepresentmentsApi {
    ...
    public setApiKey(key: RepresentmentsApiApiKeys, value: string) {
        (this.authentications as any)[RepresentmentsApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async representmentCreate (claimId: string, eventId: string, representmentCreate: RepresentmentCreate, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RepresentmentCreateEventId;  }> {
        const localVarPath = this.basePath + '/claims/{claim_id}/chargebacks/{event_id}/representments'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(representmentCreate, "RepresentmentCreate")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: RepresentmentCreateEventId;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "RepresentmentCreateEventId");
     ...
     */
    public async reverseRepresentment (claimId: string, eventId: string, representmentReversal: RepresentmentReversal, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RepresentmentReversalEventId;  }> {
        const localVarPath = this.basePath + '/claims/{claim_id}/representments/{event_id}/reversals'
            .replace('{' + 'claim_id' + '}', encodeURIComponent(String(claimId)))
            .replace('{' + 'event_id' + '}', encodeURIComponent(String(eventId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(representmentReversal, "RepresentmentReversal")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: RepresentmentReversalEventId;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "RepresentmentReversalEventId");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async updateRepresentment (claimId: string, eventId: string, representmentUpdate: RepresentmentUpdate, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/claims/{claim_id}/representments/{event_id}'
            .replace('{' + 'claim_id' + '}', encodeURIComponent(String(claimId)))
            .replace('{' + 'event_id' + '}', encodeURIComponent(String(eventId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(representmentUpdate, "RepresentmentUpdate")
        };
