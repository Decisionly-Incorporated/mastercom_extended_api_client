...
var QueuesApi = /** @class */ (function () {
     ...
     */
    QueuesApi.prototype.getQueueDefinition = function (queueId_1) {
        return __awaiter(this, arguments, void 0, function (queueId, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/queues/{queue_id}'
                            ...
                            (0, dropin_request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "QueueDefinition");
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, dropin_request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "QueueDefinitionsList");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new apis_1.HttpError(response, body, response.statusCode));
     ...
     * @param limit Number of items the list should be limited to.
     */
    QueuesApi.prototype.queueSearch = function (queueId_1, startDateTime_1, endDateTime_1, offset_1, limit_1) {
        return __awaiter(this, arguments, void 0, function (queueId, startDateTime, endDateTime, offset, limit, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_3, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/queues/{queue_id}/claims'
                    .replace('{' + 'queue_id' + '}', encodeURIComponent(String(queueId)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                ...
                if (startDateTime !== undefined) {
                    localVarQueryParameters['start_date_time'] = models_1.ObjectSerializer.serialize(startDateTime, "Date");
                }
                if (endDateTime !== undefined) {
                    localVarQueryParameters['end_date_time'] = models_1.ObjectSerializer.serialize(endDateTime, "Date");
                }
                if (offset !== undefined) {
                    localVarQueryParameters['offset'] = models_1.ObjectSerializer.serialize(offset, "number");
                }
                        ...
                        return new Promise(function (resolve, reject) {
                            (0, dropin_request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "Queue");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new apis_1.HttpError(response, body, response.statusCode));
