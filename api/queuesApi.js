...
exports.QueuesApi = exports.QueuesApiApiKeys = void 0;
...
// ===============================================
var QueuesApiApiKeys;
(function (QueuesApiApiKeys) {
})(QueuesApiApiKeys || (exports.QueuesApiApiKeys = QueuesApiApiKeys = {}));
var QueuesApi = /** @class */ (function () {
    function QueuesApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(QueuesApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(QueuesApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(QueuesApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    QueuesApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    QueuesApi.prototype.setApiKey = function (key, value) {
        this.authentications[QueuesApiApiKeys[key]].apiKey = value;
    };
    QueuesApi.prototype.addInterceptor = function (interceptor) {
        ...
        return __awaiter(this, arguments, void 0, function (queueName, options) {
            ...
            return __generator(this, function (_b) {
                ...
                if (queueName !== undefined) {
                    localVarQueryParameters['queue-name'] = models_1.ObjectSerializer.serialize(queueName, "string");
                }
                            ...
                            localVarRequest(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "Array<ClaimSummary>");
     ...
     */
    QueuesApi.prototype.getQueueSummaryPost = function (body_1) {
        return __awaiter(this, arguments, void 0, function (body, options) {
            ...
            return __generator(this, function (_b) {
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(body, "GetQueueContentRequest")
                };
                authenticationPromise = Promise.resolve();
                authenticationPromise = authenticationPromise.then(function () { return _this.authentications.default.applyToRequest(localVarRequestOptions); });
                interceptorPromise = authenticationPromise;
                        ...
                        return new Promise(function (resolve, reject) {
                            localVarRequest(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "QueueContentSummary");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new apis_1.HttpError(response, body, response.statusCode));
     ...
     */
    QueuesApi.prototype.getQueues = function () {
        return __awaiter(this, arguments, void 0, function (options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_3, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/v6/queues/names';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
                        ...
                        return new Promise(function (resolve, reject) {
                            localVarRequest(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "Array<Queue>");
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new apis_1.HttpError(response, body, response.statusCode));
