...
export class TransactionsApi {
     ...
     */
    public async transactionSearch (transactionSearch: TransactionSearch, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionList;  }> {
        const localVarPath = this.basePath + '/transactions/searches';
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(transactionSearch, "TransactionSearch")
        };
