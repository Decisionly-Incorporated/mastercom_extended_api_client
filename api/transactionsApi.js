...
var TransactionsApi = /** @class */ (function () {
     ...
     */
    TransactionsApi.prototype.transactionSearch = function (transactionSearch_1) {
        return __awaiter(this, arguments, void 0, function (transactionSearch, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/transactions/searches';
                ...
                localVarFormParams = {};
                // verify required parameter 'transactionSearch' is not null or undefined
                if (transactionSearch === null || transactionSearch === undefined) {
                    throw new Error('Required parameter transactionSearch was null or undefined when calling transactionSearch.');
                }
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(transactionSearch, "TransactionSearch")
                };
                            ...
                            (0, dropin_request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "TransactionList");
