...
export class ChargebackReversal {
    /**
    * Reason code submitted for the chargeback reversal.  *Valid Values/Format:* Numeric 
    */
    'reasonCode': string;
    'singleMessage'?: ChargebackSingleMessageReversal;
