...
*/
var AmountDetails = /** @class */ (function () {
    function AmountDetails() {
    }
    AmountDetails.getAttributeTypeMap = function () {
        return AmountDetails.attributeTypeMap;
    };
    AmountDetails.discriminator = undefined;
    AmountDetails.attributeTypeMap = [
        {
            "name": "displayAmount",
