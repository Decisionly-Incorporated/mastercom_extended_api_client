...
export class ChargebackUpdate {
    /**
    * Setting this parameter to true moves the claim to the Worked queue. Issuers may take further actions on acknowledged claims.
    */
    'acknowledge': boolean;
